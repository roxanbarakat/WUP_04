...
To summarize, we looked at a box plot, numerical results, and inferential results to conclude that both LT high school and graduate as well as high school and graduate have statistical differences at the 95% level. We infer those reults through looking at the mean/average of each. Graduate degree is 10 being the highest, the average for the Junior college is 9.91, the average for the Bachelor degree is 9.20, the average for High school is 8.28, and finally the average for LT High school is the lowest being 7.75.
